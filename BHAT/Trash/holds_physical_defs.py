...
def roadside_wait_here_text(): 
	...
	print(" TEST " + str(char.backpack) + str(char.whoami))
	...
	rear of the compound. Ten meters to you left is a four meter tall 
...
def elevator_push_sub_three_text(): 
	...
	if 'rubber ducky' in pers_inv:
		print('''
	2. Rubber Ducky
	
	''')
		choice2 = '2'
	if 'raspberry pi' in pers_inv:
		print('''
	3. Raspberry Pi
...
def mission_complete_text(): 
	...
	sleep(3)
	print('''
	root@SpaceZ:~$ sudo echo {PLAYER_NAME} > ConfirmedNames.txt''')
	sleep(3)
	print('''
